...
class App extends Component {
  ...
  search(e){
    e.preventDefault();
    window.location.assign(`https://stockfootage.com/?s=middle east+${this.state.search}&post_type=product`);
  }
  render() {
    return (
      <div className="App">
        ...
        <div id="vidtop-content">
          ...
          <div className="interact-box">
            <img src={logo} alt=""/>
            <h1><span style={{color: 'rgb(188, 52, 38)'}}>Middleeast</span>Footage.com</h1>
        ...
        <div className="info-sec">
          <section>
            <h1>Middle East <a className="rf" href="https://en.wikipedia.org/wiki/Royalty-free">Royalty-Free</a> Stock Footage Marketplace (contact us for 4K)</h1>
            <h4 className="sub-banner">MiddleeastFootage.com is a division of <a style={{textDecoration:'none', color: '#999'}} href="https://stockfootage.com/">StockFootage.com</a></h4>
          </section>
		...
		<section className="category-sec">
				...
				<div className="categories">
						<a href="https://stockfootage.com/?s=middle east+Jerusalem&post_type=product" className="cat">Jerusalem</a>
						<a href="https://stockfootage.com/?s=middle east+Palestine&post_type=product" className="cat">Palestine</a>
						<a href="https://stockfootage.com/?s=middle east+Dead+Sea&post_type=product" className="cat">Dead Sea</a>
						<a href="https://stockfootage.com/?s=middle east+Sea+of+Galilee&post_type=product" className="cat">Sea of Galilee</a>
						<a href="https://stockfootage.com/?s=middle east+Jordan+River&post_type=product" className="cat">Jordan River</a>
						<a href="https://stockfootage.com/?s=middle east+Ein+Gedi&post_type=product" className="cat">Ein Gedi</a>
						<a href="https://stockfootage.com/?s=middle east+Tel+Aviv&post_type=product" className="cat">Tel Aviv</a>
						<a href="https://stockfootage.com/?s=middle east+Caesarea&post_type=product" className="cat">Caesarea</a>
						<a href="https://stockfootage.com/?s=middle east+Beit+She'an&post_type=product" className="cat">Beit She'an</a>
						<a href="https://stockfootage.com/?s=middle east+Capernaum&post_type=product" className="cat">Capernaum</a>
						<a href="https://stockfootage.com/?s=middle east+Western+Wall&post_type=product" className="cat">Western Wall</a>
						<a href="https://stockfootage.com/?s=middle east+Dome+of+the+Rock&post_type=product" className="cat">Dome of the Rock</a>
						<a href="https://stockfootage.com/?s=middle east+Al-Aqsa+Mosque&post_type=product" className="cat">Al-Aqsa Mosque</a>
				</div>
		</section>
		<br/>		
<div className="hr-red"/>
